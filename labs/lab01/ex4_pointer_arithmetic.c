...
int main() {
  ...
  // DONE: create an int16_t array of size 4
  int16_t some_array[4];
  printf("address of the start of the array: %p\n", some_array);

  // DONE: compute the address of the element at index 2 (0-indexed)
  int16_t* ptr_to_idx_2 = &some_array[2];
  printf("address of index 2: %p\n", ptr_to_idx_2);

  // DONE: store the value 10 at index 2, using ptr_to_idx_2
  *ptr_to_idx_2 = 10;

  // DONE: print the value at index 2
