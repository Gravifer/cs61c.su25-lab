...
int main() {
  // DONE: declare a variable student of type struct Student
  // Note: this struct is stored on the stack
  struct Student student;

  // DONE: print out the size of a struct Student
  ...
  // DONE: set student's id field to 5
  // Hint: the dot notation accesses a struct's fields
  student.id = 5;

  // DONE: print out student's id field
